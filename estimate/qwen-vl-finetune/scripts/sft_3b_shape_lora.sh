...
datasets=utkface_resampled_train_normage%100,all_ages_faces_resampled_train_normage%100 # utkface_resampled_train%100,all_ages_faces_resampled_train%100
eval_datasets=all_ages_faces_resampled_val_normage%50 # all_ages_faces_resampled_val%50

# Output configuration
run_name="normage-resampled-lora-qwen25vl-3b-utkface-all_ages_faces-ageonly"
