...
datasets=utkface_resampled_train_numage%100,all_ages_faces_resampled_train_numage%100
eval_datasets=all_ages_faces_resampled_val_numage%50

# Output configuration
run_name="numage-resampled-lora-qwen25vl-3b-utkface-all_ages_faces-ageonly"
