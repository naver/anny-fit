...
datasets=utkface_resampled_train%100,all_ages_faces_resampled_train%100
eval_datasets=all_ages_faces_val%50

# Output configuration
run_name="resampled-lora-qwen25vl-7b-utkface-all_ages_faces-ageonly"
