...
class LazySupervisedDataset(Dataset):
    ...
    def __init__(self, tokenizer: transformers.PreTrainedTokenizer, data_args, dataset_names):
...
def make_supervised_data_module(
    ...
    train_dataset = LazySupervisedDataset(tokenizer=tokenizer, data_args=data_args, dataset_names=data_args.dataset_use)
    if len(data_args.eval_dataset_use) > 0:
        eval_dataset = LazySupervisedDataset(tokenizer=tokenizer, data_args=data_args, dataset_names=data_args.eval_dataset_use)
    else:
        eval_dataset = None
