# config from: https://github.com/ViTAE-Transformer/ViTPose/blob/main/configs/hand/2d_kpt_sview_rgb_img/topdown_heatmap/interhand2d/ViTPose_huge_interhand2d_all_256x192.py
_base_ = [
    'default_runtime.py',
    'datasets/interhand2d.py'
]
