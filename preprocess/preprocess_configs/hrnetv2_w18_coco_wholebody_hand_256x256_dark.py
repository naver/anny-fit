# config from: https://github.com/ViTAE-Transformer/ViTPose/blob/main/configs/hand/2d_kpt_sview_rgb_img/topdown_heatmap/coco_wholebody_hand/hrnetv2_w18_coco_wholebody_hand_256x256_dark.py
_base_ = [
    'default_runtime.py',
    'datasets/coco_wholebody_hand.py'
]
evaluation = dict(
