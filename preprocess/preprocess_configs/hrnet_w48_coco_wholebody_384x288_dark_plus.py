# taken from: https://github.com/ViTAE-Transformer/ViTPose/blob/main/configs/wholebody/2d_kpt_sview_rgb_img/topdown_heatmap/coco-wholebody/hrnet_w48_coco_wholebody_384x288_dark_plus.py
_base_ = [
    'default_runtime.py',
    'datasets/coco_wholebody.py'
]
